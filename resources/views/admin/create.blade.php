                ...
                <div class="layui-field-box">
					...
					@csrf
                        <div class="layui-form-item"> 
                            ...
                            <input type="text" name="admin_name" required style="width:190px" lay-verify="required" placeholder="请输入管理员名称" autocomplete="off" class="layui-input">
                        ...
                        <div class="layui-form-item">
                            ...
                            <input type="password" name="admin_pwd" required lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
						...
						<div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                            <input type="password" name="admin_pwds" required lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
...
$('input[name="admin_name"]').blur(function(){
  ...
  if(!(/^[\u4e00-\u9fa5}\w]{2,60}$/.test(admin_name))){
   ...
   $.post('/checkname',{admin_name:admin_name},function(res){
